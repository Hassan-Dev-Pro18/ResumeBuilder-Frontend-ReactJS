        ...
        <div class="t2-container">
          <div class="t2-header">
            <div>
              ...
              <p className="t2-header-p">{personalInfo.contact } | {personalInfo.email }</p>
              <p className="t2-header-p">{personalInfo.address }</p>
            </div>
            <div class="t2-image">
              <img src={image || UserImage} alt="profile pic" className="t2-img"/>
            </div>
          </div>
          ...
          <div class="t2-content">
            ...
            {skillData && (
              <section class="t2-skills">
                <h2 className="t2-section-h2">Skills</h2>
                <ul className="t2-section-ul">
                {skillData.skill1 && (<li className="t2-section-li">{skillData.skill1}</li>)}
                {skillData.skill2 && (<li className="t2-section-li">{skillData.skill2}</li>)}
                {skillData.skill3 && (<li className="t2-section-li">{skillData.skill3}</li>)}
                {skillData.skill4 && (<li className="t2-section-li">{skillData.skill4}</li>)}
                {skillData.skill5 && (<li className="t2-section-li">{skillData.skill5}</li>)}
                {skillData.skill6 && (<li className="t2-section-li">{skillData.skill6}</li>)}
                </ul>
              </section>)}
              <section class="t2-education">
                <h2 className="t2-section-h2">Education</h2>
                {edu1Details && ( <div>
                <p className="t2-section-p">
                  <strong>{edu1Details.Degree}</strong>
                </p>
                <p className="t2-section-p">{edu1Details.InstituteName}</p>
                {edu1Details && (<p className="t2-section-p"><em>{edu1Details.StartYear} -{" "}
                {edu1Details.PassOutYear}</em></p>)}</div>)}
                <p className="t2-section-p">
                  <strong>{edu2Details.Degree }</strong>
                </p>
                <p className="t2-section-p">{edu2Details.InstituteName}</p>
                {edu2Details &&(<p className="t2-section-p"><em>{edu2Details.StartYear} -{" "}
                {edu2Details.PassOutYear}</em></p>)}
                <p className="t2-section-p">
                  <strong>{edu3Details.Degree }</strong>
                </p>
                <p className="t2-section-p">{edu3Details.InstituteName}</p>
                {edu3Details &&(<p className="t2-section-p"><em>{edu3Details.StartYear} -{" "}
                {edu3Details.PassOutYear}</em></p>)}
              ...
              <section class="t2-education">
                ...
                <p className="t2-section-p"><em>{cert1Detail.IssueDate}</em></p>
                <p className="t2-section-p">
                  <strong>{cert2Detail.certificateName}</strong>
                </p>
                <p className="t2-section-p">{cert2Detail.IssuingOrg}</p>
                <p className="t2-section-p"><em>{cert2Detail.IssueDate}</em></p>

                <p className="t2-section-p">
                  <strong>{cert3Detail.certificateName}</strong>
                </p>
                <p className="t2-section-p">{cert3Detail.IssuingOrg}</p>
                <p className="t2-section-p"><em>{cert3Detail.IssueDate}</em></p>
              </section>
              {hobbiesData && (
              <section class="t2-skills">
                <h2 className="t2-section-h2">Hobbies</h2>
                <ul className="t2-section-ul">
                {hobbiesData.hobby1 && (<li className="t2-section-li">{hobbiesData.hobby1}</li>)}
                {hobbiesData.hobby2 && (<li className="t2-section-li">{hobbiesData.hobby2}</li>)}
                {hobbiesData.hobby3 && (<li className="t2-section-li">{hobbiesData.hobby3}</li>)}
                {hobbiesData.hobby4 && (<li className="t2-section-li">{hobbiesData.hobby4}</li>)}
                {hobbiesData.hobby5 && (<li className="t2-section-li">{hobbiesData.hobby5}</li>)}
                </ul>
              </section>)}
              {referenceData && (
              <section class="t2-reference">
            ...
            <div class="t2-main">
              <section class="t2-summary t2-section">
                <h2 className="t2-section-h2">Profile</h2>
                <p className="t2-section-p">
                {" "}
                  {personalInfo.objective }</p>
              </section>
              <section class="t2-work-history t2-section">
                <h2 className="t2-section-h2">Work History</h2>
                <h3 className="t2-job-h3">{exp1Detail.JobTitle}</h3>
                {exp1Detail.CompanyName &&(<p className="t2-section-pw-p">{exp1Detail.CompanyName } | ({exp1Detail.StartYear} -{" "}
                  {exp1Detail.EndYear || "Present"})</p>)}
                {exp1Detail.Responsibilties &&(<ul className="t2-section-ul">
                ...
                {exp2Detail.CompanyName &&(<p className="t2-section-pw-p">{exp2Detail.CompanyName} | ({exp2Detail.StartYear} -{" "}
                  {exp2Detail.EndYear || "Present"})</p>)}
                {exp2Detail.Responsibilties &&(<ul className="t2-section-ul">
                  <li className="t2-section-li">
                ...
                {exp3Detail.CompanyName &&(<p className="t2-section-pw-p">{exp3Detail.CompanyName} | ({exp3Detail.StartYear || "Present"} -{" "}
                  {exp3Detail.EndYear || "Present"})</p>)}
                {exp3Detail.Responsibilties &&(<ul className="t2-section-ul">
                  <li className="t2-section-li">
              ...
              <section class="t2-work-history t2-section">
                ...
                <p className="t2-section-pw-p">
                  {pro1Detail.languageFramework&&(<em>({pro1Detail.languageFramework})</em>)}
                </p>
                <ul className="t2-section-ul">
                {pro1Detail.Description&&(<li className="t2-section-li">
                  {pro1Detail.Description}
                  </li>)}
                </ul>
                <h3 className="t2-job-h3">{pro2Detail.ProjectName}</h3>
                <p className="t2-section-pw-p">
                {pro2Detail.languageFramework&&(<em>({pro2Detail.languageFramework})</em>)}
                </p>
                <ul className="t2-section-ul">
                {pro2Detail.Description&& (<li className="t2-section-li">
                  {pro2Detail.Description }
                  </li>)}
                </ul>
                <h3 className="t2-job-h3">{pro3Detail.ProjectName}</h3>
                <p className="t2-section-pw-p">
                {pro3Detail.languageFramework&&(<em>({pro3Detail.languageFramework})</em>)}
                </p>
                <ul className="t2-section-ul">
                {pro3Detail.Description&& (<li className="t2-section-li">
