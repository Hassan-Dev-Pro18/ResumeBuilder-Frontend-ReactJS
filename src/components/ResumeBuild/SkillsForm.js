...
const SkillsForm = ({ formData, setFormData, errors, setErrors }) => {
            ...
            {visibleFields >= 1 && (
              <div className="form-group">
                <div className="label-container-resume-build">
                  ...
                  {errors.skill1 && (
                    <span className="error-message">{errors.skill1}</span>
                  )}
                </div>
            ...
            {visibleFields >= 2 && (
              <div className="form-group">
                <div className="label-container-resume-build">
                  ...
                  {errors.skill2 && (
                    <span className="error-message">{errors.skill2}</span>
                  )}
                </div>
                <input
                  type="text"
            ...
            {visibleFields >= 3 && (
              <div className="form-group">
                <div className="label-container-resume-build">
                  ...
                  {errors.skill3 && (
                    <span className="error-message">{errors.skill3}</span>
                  )}
                </div>
                <input
                  type="text"
            ...
            {visibleFields >= 4 && (
              <div className="form-group">
                <div className="label-container-resume-build">
                  ...
                  {errors.skill4 && (
                    <span className="error-message">{errors.skill4}</span>
                  )}
                </div>
                <input
                  type="text"
            ...
            {visibleFields >= 5 && (
              <div className="form-group">
                <div className="label-container-resume-build">
                  ...
                  {errors.skill5 && (
                    <span className="error-message">{errors.skill5}</span>
                  )}
                </div>
                <input
                  type="text"
            ...
            {visibleFields >= 6 && (
              <div className="form-group">
                <div className="label-container-resume-build">
                  ...
                  {errors.skill6 && (
                    <span className="error-message">{errors.skill6}</span>
                  )}
                </div>
                <input
                  type="text"
